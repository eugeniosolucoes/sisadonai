...
SELECT DISTINCT dp.`CPF_PFisica`, m.`Codigo_Situacao_Aluno`, pf.`Nome_PFisica`, pf.`Codigo_PFisica`, tu.`Nome_Turma`, mens.`Data_Vencimento`, mens.`Valor_Mensalidade`, mens.`Nosso_Numero`, mens.`Codigo_Situacao_Mensalidade` 
FROM ((((((((`PFisicas` pf
