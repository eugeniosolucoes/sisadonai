 ...
 * @author eugenio
 */
public class BoletoJavaExemplo {

    private static final Logger LOG = Logger.getLogger(BoletoJavaExemplo.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            params.load(BoletoJavaExemplo.class.getResourceAsStream("/conf/boleto.properties"));
...
//            titulo.setValorCobrado(BigDecimal.ZERO);
            ...
            BoletoViewer boletoViewer = new BoletoViewer(boleto, BoletoJavaExemplo.class.getResourceAsStream("/templates/template.pdf"));

            // Gerando o arquivo. No caso o arquivo mencionado será salvo na mesma
            // pasta do projeto. Outros exemplos:
            // WINDOWS: boletoViewer.getAsPDF("C:/Temp/MeuBoleto.pdf");
            // LINUX: boletoViewer.getAsPDF("/home/temp/MeuBoleto.pdf");
            File arquivoPdf = boletoViewer.getPdfAsFile("BoletoJavaExemplo.pdf");
