...
public class HeaderCNAB400 extends AbstractCNAB400 {
    ...
    static {
        ...
        CAMPOS_HEADER.add( new Campo( "BRANCOS", new Posicao( 39, 46 ), new Picture( Picture.Type.S, 8, false ), "0" ) );
        ...
        CAMPOS_HEADER.add( new Campo( "BRANCOS_1", new Posicao( 101, 394 ), new Picture( Picture.Type.N, 294, false ), "0" ) );
