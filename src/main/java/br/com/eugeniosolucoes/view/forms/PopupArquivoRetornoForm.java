...
public class PopupArquivoRetornoForm extends javax.swing.JDialog {
    ...
    public PopupArquivoRetornoForm(java.awt.Frame parent, boolean modal, String html, int largura, int altura) {
        super(parent, BaseForm.SYSTEM_TITLE, modal);
        initComponents();
        this.html = html;
        //setEditor();
    ...
    public PopupArquivoRetornoForm(java.awt.Frame parent, boolean modal, String title, String html, int largura, int altura) {
            ...
            if ( referenciaLink.getEventType() == HyperlinkEvent.EventType.ENTERED ) {
                try {
                    try {
                        ...
                        Logger.getLogger(PopupArquivoRetornoForm.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
